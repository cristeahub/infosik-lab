...
\begin{itemize}
    ...
    \item
        ...
        This bias led to two feasible attacks on RC4, allowing full plaintext recovery from the worst one, if an attacker were to acquire many ($2^{32}$) ciphertexts, corresponding to the same message.
    \item
        Lucky 13 - Timing attack on TLS CBC-mode ciphers\cite{lucky-thirteen}.
